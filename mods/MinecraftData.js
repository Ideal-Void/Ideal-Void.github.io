...
func:function()
{
	...
	*/
	...
	G.props['fastTicksOnResearch']=256;
	...
	G.props['new day lines']=[
		...
		'Endermen screech in the distance.',
	...
	new G.Achiev({
		...
		fromUnit:'mausoleum',
		effects:[
			{type:'addFastTicksOnStart',amount:256*4},
			{type:'addFastTicksOnResearch',amount:256}
		],
	});
